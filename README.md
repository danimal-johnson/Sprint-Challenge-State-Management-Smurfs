...
* Actions - Packets of information (type and payload) that are dispatched to the reducer.
* Reducers - Take an action and create a new state tree to put in the store.
* Store - saves the current copy of the application state

- [x] What is the difference between Application state and Component state? When would be a good time to use one over the other?

* Application State - A shared storage location available for all components in the app.
* Component State - Persistent storage internal to a component. Not available outside of the component.

- [x] Describe `redux-thunk`, what does it allow us to do? How does it change our `action-creators`?

* Redux-thunk is middleware that allows Actions Creators to handle asynchronous operations.
* A thunk is a function that is returned by another.
* It allows us to run synchronous code inside of normally asynchronous react (e.g. for API calls)

- [x] What is your favorite state management system you've learned and this sprint? Please explain why!

* At the moment, it's the Flux Pattern (hooks + reducer + context). It's more straightforward and faster
  to implement for small projects. It's for that reason I'm using it over Redux today. I'd like more practice
  with the Redux model, but there's a 3-hour strict deadline.
